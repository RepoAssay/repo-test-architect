...
- shared adapter conformance keeps direct audits and every project-aware downstream artifact aligned for all nine supported adapters and the experimental Elixir foundation; the completed [cross-adapter trust review](cross-adapter-trust-report.md) records the original broader pipeline review
