...
1. Expand source-to-test matching beyond bounded relative and aliased dependencies, imported barrel symbols, and declared single-wildcard package subpaths into assertion-aware symbol usage evidence.
