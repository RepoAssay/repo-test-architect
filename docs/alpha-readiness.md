...
1. Expand source-to-test matching beyond bounded relative dependencies and declared single-wildcard package subpaths into tsconfig aliases and exported-symbol usage evidence.
