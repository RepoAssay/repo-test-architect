...
1. Expand source-to-test matching beyond bounded relative dependencies, imported barrel symbols, and declared single-wildcard package subpaths into tsconfig aliases and assertion-aware symbol usage evidence.
