...
1. Expand source-to-test matching beyond declared single-wildcard package subpaths into tsconfig aliases, transitive barrels, and exported-symbol usage evidence.
