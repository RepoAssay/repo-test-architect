...
The later assertion-usage slice retains those 287 relationships and all candidate classifications while upgrading 56 exact Testify relationships. Its current three-run median is 615 ms and normalized digest is `ef7f291da706cf6f59f0f73c9ada5c455e9914c81edac203491b9387874eba61`; details are recorded in the [Go Assertion-Usage Validation Report](go-assertion-validation-report.md).
