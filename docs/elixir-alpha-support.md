# Elixir Alpha Support

The Elixir adapter is supported at a deliberately narrow Mix/ExUnit boundary. It uses the shared audit, plan, explanation, ranking, project-analysis, CLI, MCP, golden, coverage, performance, packaging, and native-fixture contracts without implying broad Elixir support.
