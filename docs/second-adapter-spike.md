...
- audits Gradle Kotlin DSL, Gradle Groovy DSL, conventional dependency-qualified Gradle module graphs, Maven, dependency-qualified Maven reactors, cycle-safe exported-transitive module edges, Maven-wrapper/JUnit 4, and bounded Gradle/JUnit Platform Kotest common specs through the shared audit model
