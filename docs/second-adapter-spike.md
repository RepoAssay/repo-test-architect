...
- audits Gradle Kotlin DSL, Gradle Groovy DSL, conventional dependency-qualified Gradle module graphs, Maven, Maven-wrapper/JUnit 4, and explicit aggregate/Kotest boundary fixtures through the shared audit model
