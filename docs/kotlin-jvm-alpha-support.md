...
- Maven profile-activated modules, property-expanded or escaping module paths, nested reactor expansion, inherited/transitive reactor dependencies, dynamic coordinates, and nonstandard module layouts
...
4. Conventional Gradle and Maven module graphs are dependency-qualified; custom mappings, computed/nested reactors, Android, multiplatform, and unsupported-framework shapes remain visibly blocked or excluded.
...
1. Pressure nested/computed Maven reactors and carefully bounded transitive Gradle/Maven dependencies without widening ownership implicitly.
