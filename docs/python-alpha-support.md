...
- direct absolute and package-owned relative imports, explicit package re-exports, and bounded pytest fixture dependencies are covered, but application boot paths, plugin-provided fixtures, dynamically requested fixtures, and bounded source-to-source dependencies are not resolved
