...
- direct absolute and package-owned relative imports, explicit package re-exports, bounded pytest fixture dependencies, and one-hop same-owner source dependencies are covered, but application boot paths, plugin-provided/dynamically requested fixtures, deeper or cross-owner source graphs, import hooks, and runtime-conditional imports are not resolved
