...
| [Mockito-Kotlin](https://github.com/mockito/mockito-kotlin) `mockito-kotlin/` module | `7a1f513e21b9bc0a65b282c3c065b26a7f900c43` | Gradle, Kotlin, JUnit/`kotlin.test` | high; `gradle test`; no module-local blockers | 10 | 7 | 7 | about 6 ms |
...
Mockito-Kotlin confirmed mixed direct and same-package Kotlin evidence in a focused library module, including four asserted and three called relationships. Most of the repository's broader test suite lives in sibling modules, so module-local results intentionally do not claim that cross-module tests cover the library.
...
- parent wrapper and qualified task recovery when a nested module is audited directly
