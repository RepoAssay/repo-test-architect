...
- Groovy production and nonstandard test source sets, Maven/inherited/test-suite Spock execution, Spock fixture/data/extension/mock semantics, Android, multi-module, computed/multiple-JVM-target, or custom-hierarchy Kotlin Multiplatform, KMP Kotest/Spock/TestNG execution, TestNG class-level/lifecycle/generated/configured execution semantics, Kotest styles beyond `FunSpec`/`StringSpec`/`ShouldSpec`, and Kotest lifecycle/data/property semantics
