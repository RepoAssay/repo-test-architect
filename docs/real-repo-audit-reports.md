...
| [Ruby rubyzip live validation](ruby-rubyzip-validation-report.md) | Ruby, conventional Bundler gem, Minitest | `rubyzip/rubyzip` at `4209b02` | root gemspec runner ownership, exact Minitest Rake command, native tests, bounded require/unique-constant evidence | current; first Ruby live probe and evidence pressure pin |
