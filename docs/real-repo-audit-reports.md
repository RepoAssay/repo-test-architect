...
| [Ruby rubyzip live validation](ruby-rubyzip-validation-report.md) | Ruby, conventional Bundler gem, Minitest | `rubyzip/rubyzip` at `4209b02` | root gemspec runner ownership, exact Minitest Rake command, native tests, bounded require/constant/call/assertion evidence | current; first Ruby live probe and evidence pressure pin |
| [Ruby Faraday live validation](ruby-faraday-validation-report.md) | Ruby, conventional Bundler HTTP gem, RSpec | `lostisland/faraday` at `3725183` | root `.rspec` helper ownership, exact three-edge load evidence, native RSpec and service-boundary comparison | current; second Ruby live probe and RSpec pressure pin |
