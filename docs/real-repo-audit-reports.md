...
| [Ruby rubyzip live validation](ruby-rubyzip-validation-report.md) | Ruby, conventional Bundler gem, Minitest | `rubyzip/rubyzip` at `4209b02` | root gemspec runner ownership, exact Minitest Rake command, native tests, naming-evidence boundaries | current; first Ruby live probe |
