...
| [C# MSTest.Sdk v4 live validation](csharp-mstest-sdk-validation-report.md) | C#, versioned MSTest SDK, native MTP, literal project edge | `dorssel/usbipd-win` at `15e5f85` plus two complementary probes | root SDK version and runner ownership, partial usbipd graph, static command and native execution controls | current; ninth C# live probe |
