...
Rust has reached supported parity. The provisional new-adapter sequence is now Ruby, PHP, then Elixir. The sequence is directional rather than a release promise: representative public repositories and concrete adapter requests can reorder those ecosystems when they provide stronger evidence of user demand.
