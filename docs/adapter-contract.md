...
- `csharp` as an experimental adapter for one static SDK-style .NET test project or one literal production/test project pair using xUnit, NUnit, or MSTest, bounded by the [C# experimental support matrix](csharp-alpha-support.md)
