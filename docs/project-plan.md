...
1. Add a shared validation corpus, scorecard, adapter-conformance helper, and instrumented implementation coverage floors. Complete; all 18 pinned cases now have passing standardized stability and performance measurements.
