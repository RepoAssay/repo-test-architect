...
1. Add a shared validation corpus, scorecard, adapter-conformance helper, and instrumented implementation coverage floors. Complete; all 27 supported-adapter pins have passing standardized stability and performance measurements, and the corpus can stage a complete registered experimental cohort with pending reviews.
