...
5. Harden SwiftPM, Xcode, and Bazel ownership plus conservative Swift symbol evidence. Xcode workspace/project, shared-scheme, and test-plan ambiguity now blocks command selection; SwiftPM graph ownership and symbol/member evidence remain active pressure.
