...
5. Harden SwiftPM, Xcode, and Bazel ownership plus conservative Swift symbol evidence. Shared-scheme and test-plan ambiguity now blocks command selection; container ownership and symbol/member evidence remain active pressure.
