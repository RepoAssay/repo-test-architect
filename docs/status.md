...
- MCP stdio smoke check that exercises initialize, notifications, tools/list, project detection, project audit, project planning, batch requests, structured tool errors, and recovery through one server process
