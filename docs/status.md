...
- bounded Ruby `ruby-constant-reference` evidence through exact literal repository-owned load graphs, including one uniquely owned root `.rspec` helper edge, direct/referenced strength, reachable-owner ambiguity rejection, and pinned rubyzip/Faraday/Factory Bot pressure
