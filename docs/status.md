...
4. Kotlin/JVM competing root Gradle/Maven commands and incomplete Maven reactor ownership now block selection; nested reactor children remain separately detectable instead of disappearing through recursive collapse. Continue dependency and Gradle unsupported-graph pressure.
