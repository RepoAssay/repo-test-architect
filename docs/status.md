...
- bounded Go assertion-usage and parser-scope pressure across TOML, Chi, River, Zap, and Resty, including exact standard-library failure conditions, exact Testify imports, one-hop result bindings, call-site shadow checks, stable candidate/relationship counts, and a measured River parser baseline
