...
**Release review hold:** counterexample review identified defects in older adapters. Those repairs are deliberately separated into the follow-up hardening PR. Exact-commit Linux/Windows/macOS validation and release-policy review are still required.
