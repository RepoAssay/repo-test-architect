...
- JavaScript/TypeScript `tsconfig.json` path-alias evidence for exact and single-wildcard mappings, including `baseUrl`, JSON comments/trailing commas, symbol-aware aliased barrels, and bounded aliased dependencies
