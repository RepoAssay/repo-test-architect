...
- JavaScript/TypeScript existing-test matching from filename conventions, literal direct relative imports, one-hop relative barrel re-exports, and exact self-package entry imports
