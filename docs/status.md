...
`1.0.0-beta.2` was published on 2026-09-06 to npm, the Official MCP Registry and GitHub prereleases. Its [release notes](release-notes-v1.0.0-beta.2.md) cover experimental [Dart and Flutter support](dart-support.md), the final planned language addition before stable release, plus adapter trust and security fixes. The registry has eleven adapters: ten supported and one experimental. The [publication ledger](distribution-metrics.md#beta2-publication--2026-09-06) records `latest: 0.3.0` and `beta: 1.0.0-beta.2`, with community-directory refreshes tracked separately.

**Beta observation:** the [September adapter re-evaluation](adapter-re-evaluation-2026-09.md) findings are repaired by the [lexical](lexical-evidence-hardening-2026-09.md) and [ownership/command](ownership-hardening-2026-09.md) phases, including unchanged five-run audits of all eighteen ownership-repair corpus pins. Publication commit `75ae521` passed the [full three-OS release matrix](https://github.com/RepoAssay/repo-test-architect/actions/runs/34026826589). Public npm clean-install and beta.1 upgrade checks passed on macOS. The fourteen-day clean window starts September 6; continue cross-OS registry-package and real-repository validation. No Dart promotion, external-feedback waiver, RC or stable approval is implied.
