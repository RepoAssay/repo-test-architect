...
- receiver methods without an explicit type or exact simple concrete constructor result, interface dispatch, route runtime reachability, helper/custom assertions, and deeper assertion-result flow remain outside the evidence claim
