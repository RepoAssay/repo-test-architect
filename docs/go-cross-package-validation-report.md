...
The later assertion-usage and parser-scope slices preserve the same River and Zap candidate and relationship counts while enriching entrypoint usage. At that stage River's root digest was `ef4ae3299b71bbd2ad38324b812fb845cf24d93241abad65c2982f7b681ba5ca`; Zap's was `ef7f291da706cf6f59f0f73c9ada5c455e9914c81edac203491b9387874eba61`. The boundaries are documented separately in the [Go Assertion-Usage Validation Report](go-assertion-validation-report.md) and [Go Parser-Scoped Binding Validation Report](go-parser-scope-validation-report.md).

The parser-owned callable slice supersedes the single-callable file restriction: direct test provenance is retained per function or method, and the imported call must occur inside that exact body. River keeps all candidate classifications with 284 relationships; Zap becomes `1 / 49 / 9` with 259 relationships. Current measurements and the removed file-wide leakage are documented in the [Go Receiver And Callable Ownership Validation Report](go-callable-ownership-validation-report.md).
