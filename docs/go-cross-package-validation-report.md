...
The later assertion-usage and parser-scope slices preserve the same River and Zap candidate and relationship counts while enriching entrypoint usage. River's current root digest is `ef4ae3299b71bbd2ad38324b812fb845cf24d93241abad65c2982f7b681ba5ca`; Zap's remains `ef7f291da706cf6f59f0f73c9ada5c455e9914c81edac203491b9387874eba61`. The boundaries are documented separately in the [Go Assertion-Usage Validation Report](go-assertion-validation-report.md) and [Go Parser-Scoped Binding Validation Report](go-parser-scope-validation-report.md).
