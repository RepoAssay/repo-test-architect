...
- audit one conventional SDK-style C# test project or one unique literal production/test project edge, including a pair amid unrelated projects, exact immutable test-field receivers, and bounded inline `out`-result assertions, through an experimental bounded .NET adapter
