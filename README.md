...
- `swift`: Swift Package Manager, Xcode-style source layouts, Swift Testing, XCTest, Quick/Nimble, SnapshotTesting, XCTVapor, Vapor, and MongoDB boundary signals; see the [Swift alpha hardening boundary](docs/swift-alpha-support.md)
