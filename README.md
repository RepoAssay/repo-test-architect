...
- `ruby` (experimental): one conventional Bundler project with `lib/` sources, runnable Minitest or RSpec conventions, exact bounded commands, conservative basename evidence, and explicit Rails/mixed-runner blockers; see the [Ruby alpha support matrix](docs/ruby-alpha-support.md)
