...
- audit one conventional SDK-style C# test project or one unique literal production/test project edge, including a pair amid unrelated projects and exact immutable test-field receivers, through an experimental bounded .NET adapter
