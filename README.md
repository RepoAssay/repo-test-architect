...
- `javascript`: JavaScript/TypeScript repositories with Node's test runner (including TypeScript execution scripts), AVA, Vitest, Jest, Express/Supertest, and React Testing Library fixture coverage
