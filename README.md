...
- `javascript`: JavaScript/TypeScript repositories with Node's test runner (including TypeScript execution scripts), Vitest, Jest, Express/Supertest, and React Testing Library fixture coverage
