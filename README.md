...
Project detection reports PHP roots through the supported adapter and still reports unsupported Elixir roots so clients can distinguish "not audited yet" from "not present."
