...
- `csharp` (experimental): one static SDK-style test project or one literal production/test project pair with xUnit, NUnit, or MSTest attributed tests, exact project-file commands, and bounded direct type-call evidence; see the [C# experimental support matrix](docs/csharp-alpha-support.md)
