...
- audit one conventional SDK-style C# test project or one unique literal production/test project edge, including a pair amid unrelated projects, through an experimental bounded .NET adapter
