...
export const requiredFiles = [
  ...
  "src/core/repository-text-files.js",
  "src/adapters/csharp/audit.js",
  "src/adapters/csharp/directory-packages-props.js",
  "src/adapters/elixir/audit.js",
  "src/adapters/dart/audit.js",
  "docs/dart-support.md",
  "docs/dart-live-validation-report.md",
  "examples/dart-test-basic/pubspec.yaml",
  "examples/dart-test-basic/test/price_test.dart",
  "examples/dart-flutter-basic/pubspec.yaml",
  "scripts/check-dart-performance.js",
  "scripts/check-dart-native-fixtures.js",
  ...
  "docs/executor-evaluation.md",
  "docs/shared-audit-kernel-inventory.md",
  ...
  "examples/elixir-mix-exunit-basic/mix.exs",
  "examples/elixir-mix-exunit-basic/lib/sample/parser.ex",
  "examples/elixir-mix-exunit-basic/test/test_helper.exs",
  "examples/elixir-mix-exunit-basic/test/sample/parser_test.exs",
  ...
  "schemas/executor-evaluation-fixture-v1.schema.json",
  "schemas/executor-evaluation-v1.schema.json",
  "schemas/validation-corpus-v1.schema.json",
  "schemas/validation-scorecard-v1.schema.json",
  "evals/validation-corpus.json",
  "evals/executor/node-test-basic.executor-eval.json",
  "evals/executor/fixtures/node-test-basic/package.json",
  "evals/executor/fixtures/node-test-basic/src/access-policy.js",
  "evals/executor/fixtures/node-test-basic/test/smoke.test.js",
  "evals/executor/profiles/direct-node-test.js",
  "evals/executor/profiles/one-repair-node-test.js",
  "scripts/check-validation-corpus.js",
  "scripts/check-executor-evaluation.js",
  "scripts/render-validation-scorecard.js",
  "scripts/check-csharp-performance.js",
  "scripts/check-elixir-performance.js",
  "scripts/check-elixir-native-fixture.js",
  ...
  "scripts/support/executor-evaluation.js",
